...
export const categories: Category[] = [
  ...
  },
  {
    ...
    color: COLORS.mint,
    sites: [
      { name: "Minimal Mockups", url: "minimalmockups.com", desc: "무료 패키징·브랜딩 목업 (PSD)", tags: ["무료", "패키징"], addedAt: "2026-04-06" },
      { name: "Creatoom", url: "creatoom.com", desc: "650+ 무료 명함·브랜딩 목업", tags: ["무료", "명함"], addedAt: "2026-04-06" },
      { name: "Pixpine", url: "pixpine.com", desc: "상업 라이선스 무료 패키징 목업", tags: ["무료", "상업용"], addedAt: "2026-04-06" },
      { name: "Mockups-Design", url: "mockups-design.com", desc: "구독 없이 즉시 무료 다운로드 목업", tags: ["무료", "즉시"], addedAt: "2026-04-06" },
      { name: "Creatsy", url: "creatsy.com", desc: "극사실적 3D 합성 목업 (일부 유료)", tags: ["3D", "일부 유료"], addedAt: "2026-04-06" },
      { name: "Mockuuups Studio", url: "mockuuups.studio", desc: "앱·웹 디바이스 목업 전문 (일부 유료)", tags: ["디바이스", "일부 유료"], addedAt: "2026-04-06" },
    ],
  },
  {
    id: "icon",
